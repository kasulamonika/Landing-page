    ...
    >
      ...
      <article className='container mx-auto relative z-10 '>
        ...
        <div className='grid grid-cols-4 gap-4'>
          ...
          />
          <img
            src='https://images.unsplash.com/photo-1517694712619-d1a8b4901d9d?w=500&auto=format&fit=crop'
            alt='Digital interface'
            className=' object-cover w-full rounded-md h-full'
          />
          <img
            src='https://images.unsplash.com/photo-1516387938699-a93023642d8f?w=500&auto=format&fit=crop'
...
const Component = forwardRef<HTMLElement, object>((_props, _ref) => {
